...
//    private int wheelBackground = R.drawable.wheel_bg;
     ...
     * @param itemText
     */
    public void setCurrentItemByText(String itemText) {
        int currentIndex=0;
        if (viewAdapter == null || viewAdapter.getItemsCount() == 0) {
            return; // throw?
        }
        ...
        for (int i = 0; i < viewAdapter.getItemsCount(); i++) {
            if (itemText.equals(viewAdapter.getItem(i)))
                currentIndex=i;
        }
...
//        bottomShadow.draw(canvas);
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.index_list_item_sub_font));
        // 设置线宽
    ...
    public String getTextItem(int index) {
        ...
        index %= count;
        return viewAdapter.getItem(index);
    }
}
